...
function addHeader() {
    fetch("header.html")
        ...
        .then(data => {
            ...
            // 🔥 IMPORTANT : init navbar APRÈS injection
            initNavbar();
        })
        .catch(error => console.error('Error loading header:', error));
}

/* ── NAVBAR (FIX HAMBURGER) ── */
function initNavbar() {
    ...
    if (hamburger && mobileMenu) {
        ...
        console.warn("Hamburger ou menu mobile introuvable");
    }
}
